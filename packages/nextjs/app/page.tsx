...
const Home = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      animatedRefs.current.forEach(el => el && observer.unobserve(el));
      fadeInRefs.current.forEach(el => el && observer.unobserve(el));
    };
  }, []);
    ...
    <div className="text-white">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center lg:space-x-16 space-y-12 lg:space-y-0 w-full mt-24 lg:mt-0">
          <div className="lg:w-1/2 space-y-6 animated" ref={addAnimatedRef}>
            <h1 className="text-4xl lg:text-6xl font-extrabold leading-tight"
                dangerouslySetInnerHTML={{ __html: "Verify the history of <br><span class='text-aqua'>every vehicle</span>. No middlemen." }} />
            <p className="text-lg text-gris-neutro max-w-2xl">
              An immutable blockchain registry that gives you the truth about cars, motorcycles, and more, just a click away.
            </p>
      ...
      <section className="py-20 px-4 md:px-12 bg-white text-blue-900 animated" ref={addAnimatedRef}>
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            ...
            <ul className="space-y-4 text-lg">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-morado flex-shrink-0 mt-1 mr-3" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-4 text-lg">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-aqua flex-shrink-0 mt-1 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15h2v-2h-2v2zm0-4h2V7h-2v6z" />
                </svg>
      ...
      <section className="py-20 px-4 md:px-12 bg-[#0F172A] text-white">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12 animated" ref={addAnimatedRef}>It's that simple.</h2>
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="card-bg p-8 rounded-xl shadow-lg border border-gris-neutro animated" ref={addAnimatedRef}>
              <div className="flex justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-morado" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p className="text-gris-neutro">Register your vehicle and its key information, creating an immutable history.</p>
            </div>
            {/* Step 2 */}
            <div className="card-bg p-8 rounded-xl shadow-lg border border-gris-neutro animated" ref={addAnimatedRef}>
              <div className="flex justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-aqua" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="card-bg p-8 rounded-xl shadow-lg border border-gris-neutro animated" ref={addAnimatedRef}>
              ...
              <p className="text-gris-neutro">Search by VIN, license plate, or ID and access the complete vehicle history.</p>
            </div>
          </div>
        </div>
      </section>
